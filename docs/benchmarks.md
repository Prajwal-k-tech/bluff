...
## T7f — evidence budget (2026-09-12, solo-boss Tess) — PARTIAL WIN, lane banked
- Mechanism (complete, instrument-proven): (1) voluntary call rate vs Honest only ~2% (gener generic gates suppress); (2) the 74% all-in rate is FORCED calls (draw pile exhausted → must call, short-circuit bypasses decide_call) — vs a never-bluffer every forced call donates; (3) T7d's guard shuts the calls that feed opp_honest → silence/exploit triggers starve (0/123).
...
## T8d — 5-session personalization curves (2026-09-12) — HONEST NEGATIVE
