...
export default function Balatro({
  ...
  useEffect(() => {
    ...
    import("ogl").then(({ Renderer, Program, Mesh, Triangle }) => {
      ...
      // Store cleanup on the ref for the outer return; also run it
      // immediately if the effect was already torn down (dev strict mode).
      (containerRef as React.MutableRefObject<HTMLDivElement & { _cleanup?: () => void }>).current!._cleanup = cleanup;
      if (disposed) cleanup();
    });
    ...
    contrast, lighting, spinAmount, pixelFilter, spinEase, isRotate, mouseInteraction,
  ]);
